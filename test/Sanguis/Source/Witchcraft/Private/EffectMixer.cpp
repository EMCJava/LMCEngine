...
// Use A to modify B
bool CombineRight(const SaEffect& A, const SaEffect& B, SaEffect& Result)
{
	if (!A.IsModifier)
		return false;
...
// Use B to modify A
inline bool CombineLeft(const SaEffect& A, const SaEffect& B, SaEffect& Result)
{
	return CombineRight(B, A, Result);
}

bool CombineMix(const SaEffect& A, const SaEffect& B, SaEffect& Result)
{
	return false;
}
